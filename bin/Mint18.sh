...
PYTHON3="ipython3 python3-bottle python3-coverage python3-daemon python3-eventlet python3-flask python3-future python3-gevent python3-jsonschema python3-matplotlib python3-networkx python3-nine python3-numpy python3-pandas python3-pika python3-requests python3-pip python3-setuptools python3-sip python3-tk"
